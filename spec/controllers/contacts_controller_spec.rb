...
RSpec.describe ContactsController, type: :controller do
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {full_name: 'test1', email: 'test1@test.com', phone: '911111111111'}
      }
      ...
      it "updates the requested contact" do
        ...
        contact.reload
        expect(assigns(:contact).attributes.symbolize_keys[:full_name]).to eq(new_attributes[:full_name])
      end
    end
